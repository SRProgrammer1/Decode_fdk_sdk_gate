...
import org.firstinspires.ftc.teamcode.mechanisms.SetVelocityTest;
...
public class Intake_Ramp_Launch1 extends OpMode {

    ServoBench kicker = new ServoBench();
    MecanumDrive_Robot drive_r = new MecanumDrive_Robot();
    SetVelocityTest launch = new SetVelocityTest();
