...
@TeleOp(name = "TeleOp_SetPower_NormalizedVoltage", group = "TeleOp")
@Disabled
public class Teleop_Setpower_NormalizedVoltage extends OpMode {
...
// B = -20 RPM once
        ...
        flywheel.setMotorSpeed(Normalized_targetPower,Normalized_targetPower);
        ...
        //telemetry.addData("Motor1 Velocity TPS", flywheel.getMotor1Velocity());
       // telemetry.addData("Motor2 Velocity TPS", flywheel.getMotor2Velocity());
        telemetry.update();
    }
}
